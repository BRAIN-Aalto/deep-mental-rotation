...
class NeuralRenderer(nn.Module):
    ...
    def rotate_from_source_to_target(
        ...
        """
        return self.rotation_layer.rotate_from_source_to_target(
            scene,
            azimuth_source,
            elevation_source,
            azimuth_target,
    ...
    def mirror_and_rotate(
        ...
        """
        """
        return self.rotation_layer.mirror_and_rotate(scene, rotation_params)
    ...
    def forward(self, batch):
        ...
        scenes = self.inverse_render(images)
        ...
        scenes_swapped = self.rotate_from_source_to_target(
            scenes,
            azimuth,
            elevation,
            azimuth_swapped,
        ...
        return images, rendered, scenes, scenes_rotated
