...
from transforms3d.rotations import rotate, rotate_from_source_to_target, mirror_and_rotate
...
class Rotate3d(nn.Module):
    ...
    def rotate_from_source_to_target(
        ...
        Args:
            ...
            elevation_target (torch.Tensor): Shape (batch_size,). Elevation of
                target view in degrees.
        """
        return rotate_from_source_to_target(
            volume,
            azimuth_source,
            elevation_source,
            azimuth_target,
    ...
    def mirror_and_rotate(
        ...
        """
        """
        return mirror_and_rotate(volume, rotation_params, mode=self.mode)
